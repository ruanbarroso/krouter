...
export const FREE_TIER_PROVIDERS = {
  atomesus: { id: "atomesus", alias: "atms", name: "Atomesus", image: "/providers/atomesus.png", color: "#3B82F6", textIcon: "AT", passthroughModels: true, modelsFetcher: { url: "https://api.atomesus.com/v1/models", type: "openai", authType: "apikey", authHeader: "bearer" }, website: "https://www.atomesus.com", notice: { text: "OpenAI-compatible API access to Atomesus AI (cipher model). Requires Atomesus API key.", apiKeyUrl: "https://www.atomesus.com" }, serviceKinds: ["llm"] },
  // 0.5.128 (upstream 31df0635) — Poolside Laguna models (OpenAI-compatible, reasoning-capable).
  poolside: { id: "poolside", alias: "ps", name: "Poolside", icon: "waves", color: "#0EA5E9", textIcon: "PS", passthroughModels: true, modelsFetcher: { url: "https://inference.poolside.ai/v1/models", type: "openai", authType: "apikey", authHeader: "bearer" }, website: "https://poolside.ai", notice: { text: "Laguna models (OpenAI-compatible, reasoning-capable). Requires a Poolside API key.", apiKeyUrl: "https://platform.poolside.ai/api-keys" }, serviceKinds: ["llm"] },
  ...
  nvidia: { id: "nvidia", alias: "nvidia", name: "NVIDIA NIM", icon: "developer_board", color: "#76B900", textIcon: "NV", website: "https://developer.nvidia.com/nim", notice: { text: "Free access for NVIDIA Developer Program members (prototyping & testing).", apiKeyUrl: "https://build.nvidia.com/settings/api-keys" }, modelsFetcher: { url: "https://integrate.api.nvidia.com/v1/models", type: "openai" }, serviceKinds: ["llm", "tts", "embedding"], ttsConfig: { baseUrl: "https://integrate.api.nvidia.com/v1/audio/speech", authType: "apikey", authHeader: "bearer", format: "nvidia-tts", models: [{ id: "fastpitch", name: "FastPitch" }, { id: "tacotron2", name: "Tacotron2" }] }, embeddingConfig: { baseUrl: "https://integrate.api.nvidia.com/v1/embeddings", authType: "apikey", authHeader: "bearer", models: [{ id: "nvidia/nv-embedqa-e5-v5", name: "NV EmbedQA E5 v5", dimensions: 1024 }] } },
  ...
  "cloudflare-ai": { id: "cloudflare-ai", alias: "cf", name: "Cloudflare", image: "/providers/cloudflare-ai.svg", color: "#F38020", textIcon: "CF", passthroughModels: true, website: "https://developers.cloudflare.com/workers-ai/", notice: { text: "Workers AI free tier. Requires a Cloudflare API token and Account ID.", apiKeyUrl: "https://dash.cloudflare.com/profile/api-tokens" }, serviceKinds: ["llm", "image"], hasProviderSpecificData: true },
...
export const OAUTH_PROVIDERS = {
  ...
  // 0.5.107 — serviceKinds now includes "image": Antigravity supports native
  // image generation via the gemini-*-image models (upstream 5306bd90).
  antigravity: { id: "antigravity", alias: "ag", name: "Antigravity", icon: "rocket_launch", color: "#F59E0B", deprecated: true, deprecationNotice: "⚠️ Risk Notice: This provider uses a subscription/OAuth session not officially licensed for proxy/router use. Account may be restricted or banned. Use at your own risk.", website: "https://antigravity.google", notice: { signupUrl: "https://antigravity.google" }, serviceKinds: ["llm", "image"] },
  ...
  xai: { id: "xai", alias: "xai", name: "xAI (Grok)", icon: "auto_awesome", color: "#1DA1F2", textIcon: "XA", website: "https://x.ai", notice: { apiKeyUrl: "https://console.x.ai", signupUrl: "https://x.ai" }, serviceKinds: ["llm", "imageToText", "webSearch", "image", "video"], searchViaChat: { defaultModel: "grok-4.20-reasoning", pricingUrl: "https://x.ai/api#pricing" }, authModes: ["oauth", "apikey"], hasOAuth: true },
...
export const APIKEY_PROVIDERS = {
  ...
  // upstream b04c03c6 — Alibaba Token Plan (prepaid, Singapore region).
  "alitp-intl": { id: "alitp-intl", alias: "alitp-intl", name: "Alibaba Token Plan", icon: "toll", color: "#FF6A00", textIcon: "ATP", website: "https://modelstudio.console.alibabacloud.com", notice: { text: "Prepaid Alibaba token plan (ap-southeast-1). OpenAI-compatible.", apiKeyUrl: "https://modelstudio.console.alibabacloud.com/?apiKey=1" }, serviceKinds: ["llm"] },
  ...
  xai: { id: "xai", alias: "xai", name: "xAI (Grok)", icon: "auto_awesome", color: "#1DA1F2", textIcon: "XA", website: "https://x.ai", notice: { apiKeyUrl: "https://console.x.ai" }, serviceKinds: ["llm", "imageToText", "webSearch", "image", "video"], searchViaChat: { defaultModel: "grok-4.20-reasoning", pricingUrl: "https://x.ai/api#pricing" }, authModes: ["oauth", "apikey"], hasOAuth: true },
  ...
  siliconflow: { id: "siliconflow", alias: "siliconflow", name: "SiliconFlow", icon: "cloud_queue", color: "#5B6EF5", textIcon: "SF", website: "https://cloud.siliconflow.com", notice: { apiKeyUrl: "https://cloud.siliconflow.com/account/ak" }, serviceKinds: ["llm", "image"] },
  ...
  // 0.5.98 — Featherless (upstream 0d4d4bc2): OpenAI-compatible, DeepSeek/GLM/Kimi presets. 0.5.102 — real logo asset.
  featherless: { id: "featherless", alias: "fl", name: "Featherless", image: "/providers/featherless.png", icon: "flutter_dash", color: "#111827", textIcon: "FL", website: "https://featherless.ai", notice: { apiKeyUrl: "https://featherless.ai/account/api-keys" }, serviceKinds: ["llm"] },
  // 0.5.127 — TokenRouter (upstream b4808929): OpenAI-compatible gateway to 300+ models across providers.
  tokenrouter: { id: "tokenrouter", alias: "tr", name: "TokenRouter", image: "/providers/tokenrouter.png", icon: "hub", color: "#6366F1", textIcon: "TR", website: "https://www.tokenrouter.com", notice: { text: "OpenAI-compatible gateway to 300+ models across providers.", apiKeyUrl: "https://www.tokenrouter.com" }, serviceKinds: ["llm"] },
  // 0.5.98 — Venice AI (upstream ab5ec52f): OpenAI-compatible, privacy-first. 0.5.102 — real logo + upstream description.
  venice: { id: "venice", alias: "venice", name: "Venice AI", image: "/providers/venice.png", icon: "shield", color: "#DC2626", textIcon: "VE", website: "https://venice.ai", notice: { text: "OpenAI-compatible. Private inference + uncensored models (Venice Uncensored, GLM, Qwen, DeepSeek, Llama).", apiKeyUrl: "https://venice.ai/settings/api" }, serviceKinds: ["llm"] },
  // 0.5.98 — Perplexity Agent API (upstream ce6bdf7f): separate from search-focused Perplexity above; targets the /v1/responses agent endpoint. 0.5.102 — real logo + upstream description.
  "perplexity-agent": { id: "perplexity-agent", alias: "perplexity-agent", name: "Perplexity Agent", image: "/providers/perplexity-agent.png", icon: "travel_explore", color: "#20808D", textIcon: "PA", website: "https://www.perplexity.ai", notice: { text: "Perplexity Agent API exposes GPT, Claude, Gemini, Grok, GLM, Kimi, and Sonar models through one OpenAI-compatible Responses API.", apiKeyUrl: "https://www.perplexity.ai/settings/api" }, serviceKinds: ["llm"] },
  ...
  // upstream 8af5e752 — Fish Audio TTS. Model id goes in a header, voice is a
  // reference_id; handled by the "fish-audio" format handler.
  "fish-audio": { id: "fish-audio", alias: "fish-audio", name: "Fish Audio", icon: "graphic_eq", color: "#22D3EE", textIcon: "FA", website: "https://fish.audio", notice: { text: "Fish Audio TTS. S2.1 Pro Free tier available.", apiKeyUrl: "https://fish.audio/app/api-keys/" }, serviceKinds: ["tts"], ttsConfig: { baseUrl: "https://api.fish.audio/v1/tts", authType: "apikey", authHeader: "bearer", format: "fish-audio", models: [{ id: "s2.1-pro-free", name: "S2.1 Pro Free" }, { id: "s2.1-pro", name: "S2.1 Pro" }, { id: "s2-pro", name: "S2 Pro" }, { id: "s1", name: "S1" }] } },
